...
const I18N = {
  en: {
    ...
    not_stored: "contents not kept",
    not_stored_title: "Sent attachments are delivered but not stored, so there is nothing to download here.",
    note_attachments: "",
  ...
  fr: {
    ...
    not_stored: "contenu non conservé",
    not_stored_title: "Les pièces jointes envoyées sont bien délivrées mais ne sont pas conservées ici.",
    note_attachments: "",
