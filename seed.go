...
func ensureSchema(p *Poche) error {
	...
	if err := p.AdminSchema("attachments",
		"message_id:string!required!ref=messages,filename:string,content_type:string,resend_attach_id:string,download_url:string,file_id:string,esetres_key:string,bytes:int,stored:bool"); err != nil {
